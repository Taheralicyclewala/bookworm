...
public class UserRating {
	...
	public UserRating(com.bookworm.bookrating.model.UserRating userRatingModel)
	{
		this.bookId = userRatingModel.getUserBookIdentity().getBookRating().getBookId();
		this.userId = userRatingModel.getUserBookIdentity().getUserId();
		this.rating = userRatingModel.getRating();
	}
